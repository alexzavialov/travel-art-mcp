...
export interface ArtEvent {
  id: string;
  type: "biennale" | "art-fair" | "festival" | "museum-exhibition";
  name: string;
  subtitle?: string;
  city: string;
  ...
  ticketRange?: string;
  currency?: string;
  url: string; // Canonical guide URL on travel.art (cornerstone or /calendar/<id>/)
  officialUrl?: string; // Official event website
  isCornerstone?: boolean; // True iff travel.art publishes a full long-form cornerstone for this event
  summary: string;
  highlights?: string[];
  parallelEvents?: string[];
  disclaimer?: string; // Time-sensitive caveat (staged closures, unpublished prices, presale cut-offs)
...
export const events: ArtEvent[] = [
  {
    ...
    subtitle: "82nd edition, curated by Marcela Guerrero and Drew Sawyer",
    city: "New York",
    country: "US",
    venues: ["Whitney Museum of American Art, 99 Gansevoort St, Meatpacking District"],
    startDate: "2026-03-08",
    endDate: "2026-10-12",
    publicDates: { start: "2026-03-08", end: "2026-10-12" },
    ...
    officialUrl: "https://whitney.org/exhibitions/whitney-biennial-2026",
    summary:
      "The 82nd Whitney Biennial — America's flagship survey of contemporary U.S. art — curated by Marcela Guerrero (DeMartini Family Curator) and Drew Sawyer (Sondra Gilman Curator of Photography). 56 artists/duos/collectives, with roughly 60% born after 1980 and 30% queer-identifying. Renzo Piano building in Meatpacking District. The exhibition closes in stages: Floor 5 closed 23 Aug 2026 and Floor 1 closed 7 Sep 2026; Floor 6 — the main biennial galleries — remains on view through 12 Oct 2026. Free Friday Nights (17:00–22:00) replaced Pay-What-You-Wish in 2024; Free Second Sundays all day.",
    highlights: [
      "Only Floor 6 — the main biennial galleries — is still on view; Floor 5 closed 23 Aug and Floor 1 closed 7 Sep 2026",
      "Final closing date: 12 October 2026",
    ...
    disclaimer:
      "Staged floor closures: only Floor 6 remains on view. Confirm on whitney.org before travelling.",
  ...
  {
    id: "sydney-biennale-2026",
    type: "biennale",
    name: "Biennale of Sydney 2026",
    subtitle: "25th edition",
    city: "Sydney",
    country: "AU",
    venues: [
    ...
    endDate: "2026-06-14",
    ticketRange: "Free",
    url: "/calendar/sydney-biennale-2026/",
    officialUrl: "https://www.biennaleofsydney.art/",
    summary: "The 25th Biennale of Sydney runs March–June 2026 across the city's major contemporary venues. Cockatoo Island remains the spectacle venue; Art Gallery of NSW and MCA Australia anchor the institutional core. Free admission to all venues — the rare large biennale that costs nothing.",
    highlights: [
      "All venues free admission — generous by international biennale standards",
      "Cockatoo Island (ferry from Circular Quay) is the immersive-installation venue",
      "Pair with Sydney Modern at AGNSW (the 2022 SANAA-designed wing)",
      "Autumn weather (Mar–Jun is southern-hemisphere autumn) — temperate, planning-friendly",
    ],
    lastVerified: "2026-06-17",
  },
  {
    id: "rothko-florence-2026",
    type: "museum-exhibition",
    name: "Rothko in Florence",
    city: "Florence",
    country: "IT",
    venues: [
      "Palazzo Strozzi",
    ...
    startDate: "2026-03-14",
    endDate: "2026-08-23",
    ticketRange: "€16 standard",
    url: "/calendar/rothko-florence-2026/",
    officialUrl: "https://www.palazzostrozzi.org/en/",
    summary: "Palazzo Strozzi traces Mark Rothko's complete arc — early figurative work through the late Seagram and Houston Chapel scale — across 70+ paintings loaned from MoMA, the Met, Tate, the Pompidou and the Rothko estate. The first major Rothko retrospective in Italy.",
    highlights: [
      "70+ Rothko works from MoMA, Met, Tate, Pompidou, Rothko estate",
      "Spans early figurative through Multiform → Color Field → Black-Form Paintings",
      "Pair with the Uffizi (10-minute walk) for a Renaissance-to-Rothko day",
      "Open Mondays (unlike Uffizi/Accademia) — Monday Florence visitors save here",
    ],
    lastVerified: "2026-06-17",
  },
  {
    id: "raphael-met-2026",
    type: "museum-exhibition",
    name: "Raphael Retrospective at the Met",
    city: "New York",
    country: "US",
    venues: [
      "The Metropolitan Museum of Art (Fifth Ave main building)",
    ],
    startDate: "2026-03-15",
    endDate: "2026-07-12",
    ticketRange: "$30 standard ($25 senior, $17 student); NY-state/NJ/CT pay-what-you-wish with ID",
    url: "/calendar/raphael-met-2026/",
    officialUrl: "https://www.metmuseum.org/",
    summary: "The Met stages a 200-work Raphael retrospective — drawings, panel paintings, tapestry cartoons — drawn from the Uffizi, the Vatican, the Louvre, the National Gallery London, and the Albertina. The first major Raphael retrospective in the U.S. since the 1980s.",
    highlights: [
      "200 works — drawings + panel paintings + tapestry cartoons",
      "Loans from Uffizi, Vatican, Louvre, National Gallery London, Albertina",
      "First U.S. Raphael retrospective since the 1980s",
      "Pair with the Met's permanent collection on a 1-day ticket (3 days at Cloisters too)",
    ],
    lastVerified: "2026-06-17",
  },
  {
    ...
    endDate: "2026-03-29",
    ticketRange: "HK$280 standard day / HK$880 multi-day",
    url: "/calendar/art-basel-hong-kong-2026/",
    officialUrl: "https://www.artbasel.com/hong-kong",
    summary: "Art Basel's Asia-Pacific flagship — the largest contemporary fair anywhere in Asia. ~240 galleries with deep Asian and Asia-Pacific representation, vetted under the same Art Basel methodology that runs Basel, Paris, and Miami. VIP previews 25–26 March; public days 27–29 March.",
    highlights: [
      "~240 galleries — Asia's largest contemporary fair",
      "VIP previews 25–26 March (collector first-access)",
      "Pair with M+ (Herzog & de Meuron, opened 2021), the Asia Society, Tai Kwun",
      "Hong Kong dim sum mid-week + Lan Kwai Fong evenings — the trip works as a 4-day cultural visit",
    ],
    lastVerified: "2026-06-17",
  },
  {
    id: "duchamp-moma-2026",
    type: "museum-exhibition",
    name: "Marcel Duchamp Retrospective at MoMA",
    city: "New York",
    country: "US",
    venues: [
    ...
    endDate: "2026-08-22",
    publicDates: { start: "2026-04-12", end: "2026-08-22" },
    ticketRange: "$30 walk-up / $28 online; 16-and-under free",
    currency: "USD",
    url: "/calendar/duchamp-moma-2026/",
    officialUrl: "https://www.moma.org/",
    summary: "MoMA and the Philadelphia Museum of Art together stage a 300-work Duchamp retrospective — from the Nude Descending a Staircase to the late posthumous Étant donnés — co-organized with the Centre Pompidou (which presents the Paris version spring 2027). The most comprehensive Duchamp survey in 50 years.",
    highlights: [
      "300 works across MoMA + Philadelphia Museum of Art",
      "Co-organized with Centre Pompidou (Paris version: spring 2027)",
      "Most comprehensive Duchamp survey since the 1973 Philadelphia/MoMA show",
      "MoMA's UNIQLO Free Friday Nights apply (4–8 PM, NY-residents only with ID 2025+)",
      "CLOSED at MoMA since 22 Aug 2026 — the retrospective reopens at the Philadelphia Museum of Art on 10 Oct 2026 (see duchamp-philadelphia-2026)",
    ],
    parallelEvents: ["duchamp-philadelphia-2026"],
    disclaimer:
      "This MoMA run has ended (22 Aug 2026). The retrospective continues in Philadelphia, 10 Oct 2026 – 31 Jan 2027, then travels to Paris in 2027.",
    lastVerified: "2026-09-14",
  },
  {
    id: "duchamp-philadelphia-2026",
    type: "museum-exhibition",
    name: "Marcel Duchamp Retrospective at the Philadelphia Museum of Art",
    city: "Philadelphia",
    country: "US",
    venues: [
    ...
    endDate: "2027-01-31",
    publicDates: { start: "2026-10-10", end: "2027-01-31" },
    url: "/calendar/duchamp-philadelphia-2026/",
    officialUrl: "https://philamuseum.org/",
    summary: "The first US Duchamp retrospective since 1973 — roughly 300 works across painting, drawing, sculpture, photography, film, printed matter and the readymades — moves from MoMA to Philadelphia, the museum that holds the world's largest Duchamp collection. It runs 10 October 2026 – 31 January 2027, then travels to Paris in 2027, co-produced by the Centre Pompidou and the Grand Palais.",
    highlights: [
      "First US Duchamp retrospective since 1973, ~300 works",
      "Philadelphia holds the largest Duchamp collection in the world — including Étant donnés, which never travels",
      "Closed at MoMA on 22 Aug 2026; opens here 10 Oct 2026",
      "Travels on to Paris in 2027, co-produced by Centre Pompidou and the Grand Palais",
    ],
    parallelEvents: ["duchamp-moma-2026"],
    disclaimer:
      "Ticket pricing for the Philadelphia run is not yet published (TBC). Confirm on philamuseum.org before booking.",
    lastVerified: "2026-09-14",
  },
  {
    id: "expo-chicago-2026",
    type: "art-fair",
    name: "EXPO Chicago 2026",
    city: "Chicago",
    country: "US",
    venues: [
    ...
    endDate: "2026-04-12",
    ticketRange: "~$30 day / $60 multi-day",
    url: "/calendar/expo-chicago-2026/",
    officialUrl: "https://www.expochicago.com/",
    summary: "EXPO Chicago — the Midwest's flagship contemporary fair, on the Navy Pier lakefront. Around 170 galleries, with stronger Latin American and Midwestern representation than the coastal fairs. Acquired by Frieze in 2023; now part of the Frieze portfolio.",
    highlights: [
      "Navy Pier lakefront venue — Lake Michigan views, generous booth spacing",
      "Strong Latin American and Midwestern gallery focus",
      "Owned by Frieze since 2023 — convergent VIP programmes with Frieze NY",
      "Pair with the Art Institute of Chicago across the river",
    ],
    lastVerified: "2026-06-17",
  },
  {
    ...
    endDate: "2026-05-10",
    ticketRange: "~$70 standard",
    url: "/calendar/frieze-new-york-2026/",
    officialUrl: "https://www.frieze.com/fairs/frieze-new-york",
    summary: "Frieze New York's smaller, sharper format inside The Shed at Hudson Yards. ~65 galleries, intentionally curated for Manhattan's apartment-collector context. Concurrent with the Whitney Biennial mid-run and the Met Gala first week of May.",
    highlights: [
      "Compact ~65-gallery format inside The Shed (Hudson Yards)",
      "Overlaps Whitney Biennial 2026 — pair on one NYC trip",
      "Met Gala on Monday 4 May (the opening week)",
      "Independent NY runs concurrently — natural pairing",
    ],
    lastVerified: "2026-06-17",
  },
  {
    id: "tefaf-new-york-2026",
    type: "art-fair",
    name: "TEFAF New York 2026",
    city: "New York",
    country: "US",
    venues: [
      "Park Avenue Armory (Park Ave at 67th)",
    ],
    startDate: "2026-05-15",
    endDate: "2026-05-19",
    ticketRange: "~$60 day / $100 multi-day",
    url: "/calendar/tefaf-new-york-2026/",
    officialUrl: "https://www.tefaf.com/fairs/tefaf-new-york",
    summary: "TEFAF's New York edition at the Park Avenue Armory — a tightly curated, museum-grade fair focused on 20th-century modern, post-war, and design. ~90 dealers vetted under TEFAF Maastricht's rigorous standards. The American counterpart to Maastricht's pre-1920 sister fair.",
    highlights: [
      "Park Avenue Armory — historic landmark venue (1881 Beaux-Arts)",
      "~90 dealers, museum-grade vetting (4-day pre-fair vetting process)",
      "Focus on 20th-c modern + post-war + design (vs Maastricht's pre-1920 focus)",
      "Pair with the Met (10-min walk), the Frick, the Guggenheim",
    ],
    lastVerified: "2026-06-17",
  },
  {
    id: "yokohama-triennale-2027",
    type: "biennale",
    name: "Yokohama Triennale 2027",
    subtitle: "9th edition, co-artistic directors Cosmin Costinaș and Inti Guerrero",
    city: "Yokohama",
    country: "JP",
    venues: [
      "Yokohama Museum of Art",
      "Additional city venues TBC",
    ],
    startDate: "2027-04-23",
    endDate: "2027-09-12",
    publicDates: { start: "2027-04-23", end: "2027-09-12" },
    url: "/calendar/yokohama-triennale-2027/",
    officialUrl: "https://www.yokohamatriennale.jp/english/",
    summary: "The 9th Yokohama Triennale — a 124-day edition led by co-artistic directors Cosmin Costinaș and Inti Guerrero, centred on Yokohama Museum of Art and timed to coincide with GREEN×EXPO 2027. There was no 2026 edition: the triennale ran in 2001, 2005, 2008, 2011, 2014, 2017, 2020 and 2024, and resumes in 2027. Closed Thursdays. Ticket prices are not yet published.",
    highlights: [
      "There is no 2026 Yokohama Triennale — the next edition is 23 Apr – 12 Sep 2027",
      "Closed Thursdays — the single most common way to waste a day here",
      "Runs alongside GREEN×EXPO 2027, so Yokohama hotel supply will be tight",
      "Costinaș and Guerrero previously directed 'Ten Thousand Suns', the 24th Biennale of Sydney",
      "30 min from central Tokyo — doable as a day trip, better as an overnight",
    ],
    disclaimer:
      "Ticket prices for 2027 are unpublished (TBC). The e-tix.jp portal still serves unlabelled 2024 prices — do not treat those as 2027 pricing.",
    lastVerified: "2026-09-14",
  },
  {
    id: "frieze-seoul-2026",
    type: "art-fair",
    name: "Frieze Seoul 2026",
    city: "Seoul",
    country: "KR",
    venues: [
      "COEX (Gangnam, Hall C/D)",
    ],
    startDate: "2026-09-02",
    endDate: "2026-09-05",
    ticketRange: "~₩70,000 standard",
    url: "/calendar/frieze-seoul-2026/",
    officialUrl: "https://www.frieze.com/fairs/frieze-seoul",
    summary: "Frieze Seoul's fourth edition at COEX, running concurrently with the long-established Kiaf Seoul under the same roof. The Asian frontier of the Frieze platform — Korea's contemporary collector base has tripled since 2022. ~110 galleries with deep Korean/Japanese/Chinese representation.",
    highlights: [
      "Co-located with Kiaf Seoul under one roof (one ticket, both fairs)",
      "Strong Korean + Japanese + Chinese gallery representation",
      "Gangnam district context — Leeum Museum 15 min, Hannam-dong galleries 10 min by taxi",
      "Frieze Seoul does NOT conflict with Armory NY in 2026 (separate weeks)",
    ],
    lastVerified: "2026-06-17",
  },
  {
    id: "armory-show-2026",
    type: "art-fair",
    name: "The Armory Show 2026",
    city: "New York",
    country: "US",
    venues: [
      "Javits Center (Hall 3A, West Side)",
    ],
    startDate: "2026-09-24",
    endDate: "2026-09-27",
    ticketRange: "~$70 standard / $120 VIP",
    url: "/calendar/armory-show-2026/",
    officialUrl: "https://www.thearmoryshow.com/",
    summary: "The Armory Show — New York's autumn flagship fair, at the Javits Center on Manhattan's West Side. ~225 galleries across Galleries, Presents (younger), Focus (curated themes), and Platform (large-scale installations). Frieze-owned since 2023.",
    highlights: [
      "~225 galleries — NYC's largest art fair",
      "Javits Center venue — large-scale installation friendly",
      "Frieze-owned since 2023; VIP programmes converge with Frieze NY/London",
      "Pair with Independent NY and 1-54 NYC (Sep 5–7) — the full NYC Sep art week",
    ],
    lastVerified: "2026-06-17",
  },
  {
    id: "lyon-biennale-2026",
    type: "biennale",
    name: "Lyon Biennale 2026",
    subtitle: "18th edition: Passer d'un rêve à l'autre / To pass from one dream to another",
    city: "Lyon",
    country: "FR",
    venues: [
      "Musée d'art contemporain de Lyon (macLYON)",
      "Usines Fagor (Gerland)",
      "Various city venues",
    ],
    startDate: "2026-09-19",
    endDate: "2026-12-13",
    publicDates: { start: "2026-09-19", end: "2026-12-13" },
    ticketRange: "PASS €25 full price / €20 presale (presale ends 18 September 2026)",
    currency: "EUR",
    url: "/calendar/lyon-biennale-2026/",
    officialUrl: "https://www.labiennaledelyon.com/en/",
    summary: "The 18th Biennale d'art contemporain de Lyon, 'Passer d'un rêve à l'autre / To pass from one dream to another', runs 19 September – 13 December 2026. A single €25 PASS covers the four paid venues — macLYON, the Musée des Confluences and two deliberately unconventional sites (a car park and a métro station) — alongside the post-industrial Usines Fagor. France's most significant biennale outside Paris.",
    highlights: [
      "€20 presale PASS ends 18 September 2026, one day before opening; €25 thereafter",
      "One PASS covers all four paid venues",
      "Venues include Parking LPA Saint-Antoine and Gare Part-Dieu métro station, not only museums",
      "Usines Fagor — 29,000m² post-industrial venue, central to the format",
      "Per-venue opening hours differ and are not aggregated on the official site — check each before travelling",
      "Lyon TGV from Paris — 2h direct, easy day-trip-plus-overnight",
    ],
    disclaimer:
      "Presale pricing (€20) ends 18 September 2026; the PASS is €25 after that. Opening hours differ per venue — confirm on labiennaledelyon.com.",
    lastVerified: "2026-09-14",
  },
  {
    id: "gwangju-biennale-2026",
    type: "biennale",
    name: "Gwangju Biennale 2026",
    subtitle: "16th edition",
    city: "Gwangju",
    country: "KR",
    venues: [
      "Gwangju Biennale Exhibition Hall",
      "May 18 Democratic Plaza",
      "Various Gwangju venues",
    ],
    startDate: "2026-09-05",
    endDate: "2026-11-15",
    publicDates: { start: "2026-09-05", end: "2026-11-15" },
    ticketRange: "Adult ₩20,000 / Youth ₩10,000 / Child ₩7,000",
    currency: "KRW",
    url: "/calendar/gwangju-biennale-2026/",
    officialUrl: "https://www.gwangjubiennale.org/eng",
    summary: "The 16th Gwangju Biennale, 'You Must Change Your Life', at the Gwangju Biennale Exhibition Hall, 111 Biennale-ro. Runs 5 September – 15 November 2026, 10:00–18:00 daily, closed Mondays except Monday 7 September and Monday 5 October 2026. Asia's oldest biennale (founded 1995) and one of the most curatorially serious — Gwangju's political context, the 1980 May 18 democratic uprising, gives it a strain of engagement that distinguishes it from market-adjacent peers. National Pavilions programme.",
    highlights: [
      "Closes 15 November 2026; open 10:00–18:00",
      "Closed Mondays EXCEPT Monday 7 September and Monday 5 October 2026",
      "Adult ₩20,000 · Youth ₩10,000 · Child ₩7,000",
      "The venue is the Exhibition Hall at 111 Biennale-ro — the Foundation's own address is 115, a different building",
      "Asia's oldest biennale (founded 1995)",
      "National Pavilions programme — curated country-by-country pavilions across the city",
      "Politically engaged tradition (rooted in the May 18 democratic movement)",
      "KTX from Seoul: 1h45 to Gwangju Songjeong; combine with Frieze Seoul (Sep 2–5)",
    ],
    disclaimer:
      "Prices in South Korean won (KRW): adult admission is ₩20,000, not ₩2,000. Verify on gwangjubiennale.org before booking.",
    lastVerified: "2026-09-14",
  },
  {
    id: "1-54-london-2026",
    type: "art-fair",
    name: "1-54 Contemporary African Art Fair London 2026",
    city: "London",
    country: "GB",
    venues: [
    ...
    endDate: "2026-10-18",
    ticketRange: "~£20 standard / £15 student",
    url: "/calendar/1-54-london-2026/",
    officialUrl: "https://www.1-54.com/london",
    summary: "The 14th edition of 1-54 London — the UK's flagship fair dedicated to contemporary African and diasporic art, concurrent with Frieze week and held at Somerset House on the Strand. ~60 galleries across 30+ African nations.",
    highlights: [
      "Concurrent with Frieze London week (14–18 October 2026)",
      "Somerset House venue — Strand location, Courtauld Gallery one floor up (pair)",
      "~60 galleries across 30+ African nations",
      "The October 2026 London art tourist trip — 1-54 + Frieze + Mayfair gallery walk",
    ],
    lastVerified: "2026-06-17",
  },
  {
    ...
    type: "biennale",
    name: "Manifesta 16 Ruhr 2026",
    subtitle: "European Nomadic Biennial",
    city: "Ruhr (Duisburg, Essen, Gelsenkirchen, Bochum)",
    country: "DE",
    venues: [
      "12 post-war churches across Duisburg, Essen, Gelsenkirchen and Bochum",
      "St. Gertrud, Markuskirche, St. Marien, Kulturkirche Liebfrauen, St. Bonifatius and others",
      "'Manifesta 16+' satellites: Dortmund, Herne, Mülheim an der Ruhr, Marl, Bottrop, Oberhausen",
    ],
    startDate: "2026-06-21",
    endDate: "2026-10-04",
    publicDates: { start: "2026-06-21", end: "2026-10-04" },
    ticketRange: "Free — no ticket required",
    url: "/calendar/manifesta-16-ruhr-2026/",
    officialUrl: "https://manifesta.org/biennials/manifesta-16-ruhr-2026",
    summary: "Manifesta 16 — Europe's nomadic biennial — runs 21 June – 4 October 2026 across 12 post-war churches in Duisburg, Essen, Gelsenkirchen and Bochum, with a 'Manifesta 16+' satellite programme in Dortmund, Herne, Mülheim an der Ruhr, Marl, Bottrop and Oberhausen. Entry is free throughout, no ticket needed. Open Tue–Thu and Sun 11:00–18:00, Fri–Sat 11:00–19:00, closed Mondays.",
    highlights: [
      "Free entry to everything — no ticket needed",
      "Twelve post-war churches are the venues: St. Gertrud, Markuskirche, St. Marien, Kulturkirche Liebfrauen, St. Bonifatius and others",
      "Hours: Tue–Thu and Sun 11:00–18:00, Fri–Sat 11:00–19:00; closed Mondays",
      "Closes 4 October 2026",
      "Accessibility varies sharply church to church — some are only partly accessible and some have no wheelchair-accessible toilet",
      "Düsseldorf airport + 30 min by train — most accessible Manifesta in a decade",
    ],
    disclaimer:
      "Entry is free; any third-party listing selling a Manifesta 16 'pass' is not official. Per-church opening hours and accessibility vary — check manifesta.org.",
    lastVerified: "2026-09-14",
  },
  {
    id: "art-sg-2026",
    ...
    endDate: "2026-01-25",
    ticketRange: "SGD 65 standard",
    url: "/calendar/art-sg-2026/",
    officialUrl: "https://artsg.com/",
    summary: "Southeast Asia's flagship contemporary fair, launched 2023, at Marina Bay Sands. ~115 galleries with strong Singaporean, Indonesian, Thai, Vietnamese and Filipino representation. The Asia-Pacific year opens here in January.",
    highlights: [
      "Southeast Asia's flagship contemporary fair",
      "Strong Indonesian + Thai + Vietnamese + Filipino representation",
      "Marina Bay Sands venue — the Singapore architectural icon",
      "Pair with the National Gallery Singapore (10-min walk) and Gillman Barracks galleries",
    ],
    lastVerified: "2026-06-17",
  },
];
