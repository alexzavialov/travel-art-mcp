...
export const events: ArtEvent[] = [
  ...
  {
    id: "yokohama-triennale-2026",
    type: "biennale",
    name: "Yokohama Triennale 2026",
    ...
    endDate: "2026-10-12",
    ticketRange: "¥2,500 standard combo",
    url: "/calendar/yokohama-triennale-2026/",
    officialUrl: "https://www.yokohamatriennale.jp/english/",
    summary: "The 9th edition of Japan's flagship contemporary triennale, returning to Yokohama Museum of Art (which reopened post-renovation in 2023). Strong focus on Asia-Pacific contemporary practices. Approximately 90 artists across three primary venues plus city-wide satellites.",
    highlights: [
      "Yokohama Museum of Art reopened March 2024 after major renovation",
      "~90 artists across 3 primary venues + city satellites",
      "Asia-Pacific contemporary focus (curatorial team announced 2024)",
      "Tokyo Day-trip — 30 min from Shibuya on Minato Mirai Line",
    ],
    lastVerified: "2026-06-17",
  },
  {
  ...
  },
  {
    ...
    endDate: "2026-12-20",
    ticketRange: "€16 combo standard",
    url: "/calendar/lyon-biennale-2026/",
    officialUrl: "https://www.labiennaledelyon.com/en/",
    summary: "The 17th Biennale de Lyon spreads across Lyon's contemporary venues plus the post-industrial Usines Fagor — France's most significant biennale outside Paris, and a curatorial counterweight to the Pompidou closure. Around 80 artists across institutional and adapted-warehouse spaces.",
    highlights: [
      "Usines Fagor — 29,000m² post-industrial venue, central to the format",
      "France's most significant biennale outside Paris",
      "Curatorial counterweight to the 2026 Pompidou closure",
  ...
  },
  {
    ...
    endDate: "2026-11-30",
    ticketRange: "₩20,000 combo",
    url: "/calendar/gwangju-biennale-2026/",
    officialUrl: "https://www.gwangjubiennale.org/eng",
    summary: "Asia's oldest biennale (founded 1995) and one of the most curatorially serious. Gwangju's specific political context — the 1980 May 18 democratic uprising — gives the biennale a strain of engagement that distinguishes it from market-adjacent peers. National Pavilions programme.",
    highlights: [
  ...
  },
  {
    ...
    city: "Ruhr (Dortmund, Essen, Bochum)",
    country: "DE",
    venues: [
      "Zollverein Coal Mine Industrial Complex (Essen)",
      "Dortmunder U",
      "Multiple Ruhr post-industrial venues",
    ],
    startDate: "2026-09-12",
    endDate: "2026-11-22",
    ticketRange: "€18 combo (multi-city pass)",
    url: "/calendar/manifesta-16-ruhr-2026/",
    officialUrl: "https://manifesta.org/biennials/manifesta-16-ruhr-2026",
    summary: "Manifesta — Europe's nomadic biennial — comes to the Ruhr in 2026, anchored by the UNESCO World Heritage Zollverein Coal Mine in Essen. Manifesta's character is post-industrial-site engagement; the Ruhr is the format's perfect canvas. Approximately 100 artists across the tri-city region.",
    highlights: [
      "Zollverein UNESCO World Heritage anchor — Essen's iconic coal-mine complex",
      "Tri-city region: Dortmund + Essen + Bochum (Ruhr's industrial belt)",
      "Manifesta's signature post-industrial-site format",
